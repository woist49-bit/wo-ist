...
export const ACHIEVEMENTS: Achievement[] = [
  // Bronze
  { id: 'first_find', key: 'first_find', name: 'Erster Erfolg', description: 'Finde Paul zum allerersten Mal.', tier: 'bronze', xp_reward: 100 },
  ...
  // Silver
  { id: 'eagle_eye', key: 'eagle_eye', name: 'Adlerauge', description: 'Finde Paul in unter 5 Sekunden.', tier: 'silver', xp_reward: 500 },
  ...
  { id: 'patient_finder', key: 'patient_finder', name: 'Ausdauer-Finder', description: 'Finde Paul nach mehr als 5 Minuten intensiver Suche (ohne Fehlversuch).', tier: 'silver', xp_reward: 400 },
  ...
  { id: 'perfect_event', key: 'perfect_event', name: 'Perfekter Urlaub', description: 'Schließe ein komplettes 10-Tages-Event ab und finde Paul an jedem Tag richtig.', tier: 'gold', xp_reward: 2500 },
  ...
  { id: 'last_minute', key: 'last_minute', name: 'Nerven aus Stahl', description: 'Finde Paul in der letzten Stunde, bevor das aktuelle Bild verfällt.', tier: 'gold', xp_reward: 1000 },
]
